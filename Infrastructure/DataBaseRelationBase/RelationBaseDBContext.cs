...
public partial class RelationBaseDBContext : DbContext
{
    public RelationBaseDBContext()
    {
    }

    public RelationBaseDBContext(DbContextOptions<RelationBaseDBContext> options)
        : base(options)
    {
    }
